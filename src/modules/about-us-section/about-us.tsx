  ...
  return (
    <div className="about-us">
      ...
      <p className="about-us__text">
        Наше «Агентство переводов» готово предложить услуги по нотариальному
        заверению переводов. «Агентство переводов» работает на рынке
        переводческих услуг уже с 2018 года.исключительная исполнительность и
        ответственность сотрудников компании — еще одна сильная сторона нашего
        агентства, двери которого всегда открыты для тех, кто ценит качество и
